...
class Spectrogram(torch.nn.Module):
    ...
    # the shape after the forward function.
    ...
    def __init__(
        ...
        num_frequencies: int, optional
            the number of frequencies to sample on. Defaults to 256.
        window_size: int, optional
            the length of the spectrogram window, in frames. Defaults to 200.
